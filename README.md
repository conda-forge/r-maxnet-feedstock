...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-maxnet-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12265&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-maxnet-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-maxnet` can be installed with:

```
conda install r-maxnet
```

It is possible to list all of the versions of `r-maxnet` available on your platform with:
